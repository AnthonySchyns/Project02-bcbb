    ...
    <div class="container">
        ...
        <ul class="nav nav-justified">
            <li class="nav-item bg-secondary">
                <a class="nav-link text-white <?php if ($board == "/index.php?board=General" or $board == "/" or $board == "/index.php") {
                                                    echo 'bg-dark';
                                                } else {
                                                    echo 'bg-secondary';
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php if ($board == "/index.php?board=Development") {
                                                    echo 'bg-dark';
                                                } else {
                                                    echo 'bg-secondary';
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php if ($board == "/index.php?board=Smalltalk") {
                                                    echo 'bg-dark';
                                                } else {
                                                    echo 'bg-secondary';
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?php if ($board == "/index.php?board=Events") {
                                                    echo 'bg-dark';
                                                } else {
                                                    echo 'bg-secondary';
